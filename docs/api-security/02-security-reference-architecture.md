...
API Providers must implement [Developer Authentication](./03-api-authentication-and-authorisation-basics.md#MSDAS_MUST_API_PROVIDERS_IMPLEMENT_DEVELOPER_AUTHENTICATION), together with authentication and authorisation services to control access to APIs — see API Authentication and Authorisation Basics, below.
