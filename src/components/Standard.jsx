 ...
 * @param {string} props.id - The unique identifier for the API standard, in an upper-snake-case format, e.g. . MSDAS_MUST_NOT_X_NOTATION_HEADERS
 ...
 * <Standard id="MSDAS_MUST_NOT_X_NOTATION_HEADERS" type="MUST NOT" toolTip="API Providers **MUST NOT** used X-Notation headers, as they have been deprecated in the HTTP standard.">Providers **MUST NOT** use X- notation headers</Standard>
 */
